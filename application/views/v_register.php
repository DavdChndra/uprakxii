...
<body>
    <div class="border border rounded my-5 mx-5 px-5">
        ...
        <hr class="mb-4">
        <form action="<?= base_url(). 'Register/proses'?>" method="post" class="mb-5">
            <h6>Username</h6>
            <input type="text" name="username" placeholder="username" class="form-control mb-3">
            <h6>password</h6>
            <input type="password" name="password" placeholder="password" class="form-control mb-3">
            <input type="submit" value="Register" class="btn btn-outline-primary mb-3">
            <h6>Belum punya akun? <a href="<?= base_url(). 'login'?>" class="text-decoration-none">Login</a></h6>
        </form>
    </div>
